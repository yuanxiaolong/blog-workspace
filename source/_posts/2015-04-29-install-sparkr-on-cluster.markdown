...
1.进入 [<font color="#465999"> R官网 </font>](http://www.r-project.org/){:target="_blank"}，点击 ``` download R ``` 进入镜像站点，点击第一个 ```http://cran.rstudio.com/``` （不要进入China站点，因为里面没有src源码）

2.点击左侧导航 ``` R Sources ``` 进入下载页面，复制 [<font color="#465999"> http://cran.rstudio.com/src/base/R-3/R-3.1.2.tar.gz </font>](http://cran.rstudio.com/src/base/R-3/R-3.1.2.tar.gz){:target="_blank"}
可以通过wget下载到服务器上 ,我的云盘共享[<font color="#465999"> 点击这里 </font>](http://pan.baidu.com/s/1qW7e6Zy){:target="_blank"}
