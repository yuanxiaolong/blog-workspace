...
我的是mac的，共享百度云 [<font color="#22832f"> 点击这里 </font>](http://pan.baidu.com/s/1bnsBOIj){:target="_blank"}

配置客户端

![2](/images/vps/20150428/2.png)

![3](/images/vps/20150428/3.png)
...
[<font color="#22832f"> http://switchysharp.com/install.html </font>](http://switchysharp.com/install.html){:target="_blank"}


配置switchysharp如下，其中 “不代理的地址” 即不想用shadowsock代理访问的地址，类似 ```*.youku.com``` ，因为看视频可能流量大，VPS每月是限制流量限额的，跟手机一样。

![4](/images/vps/20150428/4.png)



参考资料：

* [<font color="#22832f"> http://teddysun.com/357.html </font>](http://teddysun.com/357.html){:target="_blank"}
* [<font color="#22832f"> http://switchysharp.com/install.html </font>](http://switchysharp.com/install.html){:target="_blank"}
